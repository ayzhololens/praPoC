...
public class PocSharingMessages : Singleton<PocSharingMessages>
{
    /// <summary>
    ...
    {
        ChangeColor = MessageID.UserMessageIDStart,
        Max
    }
    ...
    private void InitializeMessageHandlers()
    {
        ...
        for (byte index = (byte)TestMessageID.ChangeColor; index < (byte)TestMessageID.Max; index++)
        {
