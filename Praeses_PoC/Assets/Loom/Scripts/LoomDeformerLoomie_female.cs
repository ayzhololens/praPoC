...
public class LoomDeformerLoomie_female : LoomAvatar
{
    public string avatarName = "loomie_female";
    ...
    [Header("Animations")]
    public bool whassup = false;
    public AudioSource whassupSound;
    ...
    void Update ()
    {
        ...
        if (whassup) {
            loom.SetBehaviorPlayOnce ("whassup");
            whassup = false;
            if (whassupSound != null) whassupSound.Play ();
        }
