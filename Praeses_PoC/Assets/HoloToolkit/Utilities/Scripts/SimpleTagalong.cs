...
namespace HoloToolkit.Unity
{
    ...
    public class SimpleTagalong : MonoBehaviour
    {
        ...
        protected virtual void Update()
        {
            ...
            frustumPlanes = GeometryUtility.CalculateFrustumPlanes(ActorSingleton.Instance.Actor);
            ...
            else if (!interpolator.Running && EnforceDistance)
            {
                ...
                Ray ray = new Ray(ActorSingleton.Instance.Actor.transform.position, transform.position - ActorSingleton.Instance.Actor.transform.position);
        ...
        protected virtual bool CalculateTagalongTargetPosition(Vector3 fromPosition, out Vector3 toPosition)
        {
            ...
            toPosition = ActorSingleton.Instance.Actor.transform.position + ActorSingleton.Instance.Actor.transform.forward * TagalongDistance;
            ...
            if (moveRight)
            {
                ...
                ray.direction = -ActorSingleton.Instance.Actor.transform.right;
            }
            else if (moveLeft)
            {
            ...
            if (moveDown)
            {
                ...
                ray.direction = ActorSingleton.Instance.Actor.transform.up;
            }
            else if (moveUp)
            {
            ...
            ray = new Ray(ActorSingleton.Instance.Actor.transform.position, toPosition - ActorSingleton.Instance.Actor.transform.position);
            ...
            toPosition = new Vector3(toPosition.x,
                                            Mathf.Clamp(toPosition.y, ActorSingleton.Instance.Actor.transform.position.y + YLimitMin, ActorSingleton.Instance.Actor.transform.position.y + YLimitMax),
                                            toPosition.z);
