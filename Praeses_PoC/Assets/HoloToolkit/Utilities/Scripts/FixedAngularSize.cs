...
namespace HoloToolkit.Unity
{
    ...
    public class FixedAngularSize : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            startingDistance = Vector3.Distance(ActorSingleton.Actor.transform.position, transform.position);
        ...
        private void Update()
        {
            float distanceToHologram = Vector3.Distance(ActorSingleton.Actor.transform.position, transform.position);
