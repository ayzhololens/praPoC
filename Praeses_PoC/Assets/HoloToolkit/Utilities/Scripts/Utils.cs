...
namespace HoloToolkit.Unity
{
    ...
    public static class Utils
    {
        ...
        public static void MoveObjectInFrontOfUser(Transform stageTransform, Transform tran, Vector3 offset, float yawOffset)
        {
            ...
            Vector3 stageHeadPos = MathUtils.TransformPointFromTo(null, stageTransform, ActorSingleton.Actor.transform.transform.position);
            Vector3 stageHeadDir = MathUtils.TransformDirectionFromTo(null, stageTransform, ActorSingleton.Actor.transform.transform.forward);
